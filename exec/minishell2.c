...
int main(void)
{
	...
	t_token *tk2 = lst_new("a");
	t_token *tk3 = lst_new("kbir.txt");
	t_token *tk4 = lst_new("a");
	t_token *tk5 = lst_new("w.txt");
	t_token *tk6 = lst_new("a");
	t_token *tk7 = lst_new("kbiiiiir.txt");
	t_token *tk8 = lst_new("a");
	t_token *tk9 = lst_new("mn.txt");
